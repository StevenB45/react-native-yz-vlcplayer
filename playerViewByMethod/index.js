...
export default class VlCPlayerViewByMethod extends Component {
    ...
    static defaultProps = {
        endingViewText: {
            endingText: 'Fin de la lecture vidéo',
            reloadBtnText: 'Relancer',
            nextBtnText: 'Suivant'
        },
        errorViewText: {
    ...
    _onStopped = (e) => {
        ...
        if (isLive) {
            ...
            // The video may have triggered the event for some reason, and you need to play it again (except that autoplay is false by default)
        ...
        return (
            <View style={[styles.loading, {backgroundColor: 'rgb(0,0,0)'}]}>
                ...
                <View style={styles.centerContainer}>
                    ...
                    }} style={[styles.centerContainerBtn, {backgroundColor: 'rgb(230,33,41)'}]}>
            ...
            <View style={[styles.commonView, {backgroundColor: 'rgba(0,0,0,0.5)'}]}>
                <View style={styles.centerContainer}>
                    ...
                    <View style={styles.centerRowContainer}>
                        ...
                        {!autoPlayNext &&
                        hadNext && (
                            <TouchableOpacity style={[styles.centerContainerBtn, {marginLeft: 15}]} onPress={this._next}
                                              activeOpacity={1}>
                                <Icon name={'reload'} size={20} color="#fff"/>
    ...
    getNoNetInfoView = () => {
        ...
        return (
            <View
                ...
                <View style={styles.centerContainer}>
                    <Text style={styles.centerContainerText}>Le réseau n'est pas connecté, veuillez vérifier les
                        paramètres réseau</Text>
                    {/*<TouchableOpacity style={styles.centerContainerBtn} onPress={this._fetchNetWork} activeOpacity={1}>*/}
                    {/*    <Icon name={'reload'} size={20} color="#fff"/>*/}
                    {/*    <Text style={styles.centerContainerBtnText}>Réessayer</Text>*/}
                    {/*</TouchableOpacity>*/}
                </View>
            </View>
        );
    ...
    getAdView = () => {
        ...
        return (
            <View style={{position: 'absolute', height: '100%', width: '100%', top: 0, left: 0, zIndex: 888,}}>
                ...
                <TouchableOpacity activeOpacity={1} onPress={this.pauseAdToggle}
                                  style={[styles.adBtn, {position: 'absolute', left: 10, bottom: 10}]}>
                    <Icon name={adPaused ? 'play' : 'pause'} size={24} color="#fff"/>
                </TouchableOpacity>
                <TouchableOpacity activeOpacity={1} onPress={this.muteAdToggle}
                                  style={[styles.adBtn, {position: 'absolute', left: 60, bottom: 10,}]}>
    ...
    getCommonView = () => {
        ...
        return (<View style={styles.commonView}>
            <TouchableOpacity activeOpacity={1} style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}
                              onPressIn={this._onBodyPressIn} onPressOut={this._onBodyPress}>
                {showPaused && <TouchableOpacity activeOpacity={0.8} style={{
                    paddingTop: 2,
                    paddingLeft: 2,
    ...
    getControlView = () => {
        ...
        return (
            <View style={{
                ...
                <TouchableOpacity activeOpacity={1} style={{flex: 1}} onPressIn={this._onBodyPressIn}
                                  onPressOut={this._onBodyPress}>
                    {
                        this.changingSlider &&
                        ...
                        <View style={{flex: 1, backgroundColor: color2}}>
                            <View style={styles.backBtn}>
                                ...
                                <View style={{justifyContent: 'center', flex: 1, marginLeft: 10, marginRight: 10}}>
                                    {showTitle && (
                                        <Text style={{color: '#fff', fontSize: 12}} numberOfLines={1}>{title}</Text>)}
                                </View>
                                {isFull && chapterElements && (
                                    ...
                                    >
                                        <Text style={{
                                            fontSize: 13,
                                            color: this.showChapter ? 'red' : '#fff'
                                        }}>{chapterText}</Text>
                                    </TouchableOpacity>
                                )}
                            </View>
